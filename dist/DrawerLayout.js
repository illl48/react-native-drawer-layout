...
var _class, _temp, _jsxFileName = 'src/DrawerLayout.js';
...
var DrawerLayout = (_temp = _class = (function(_Component) {
  ...
  function DrawerLayout(props, context) {
    ...
    _this._panResponder = _reactNative.PanResponder.create({
      onMoveShouldSetPanResponder: _this._shouldSetPanResponder,
      onPanResponderGrant: _this._panResponderGrant,
      onPanResponderMove: _this._panResponderMove,
      onPanResponderTerminationRequest: function onPanResponderTerminationRequest() {
        return false;
      },
      onPanResponderRelease: _this._panResponderRelease,
